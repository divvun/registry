...
| [kbdgen](https://github.com/divvun/kbdgen) | The keyboard layout generator, outputting Android, iOS, Windows, macOS and Linux keyboard layouts. | Rust/Python | macOS/Linux/Windows | Apache 2.0 OR MIT | [![Build Status](https://dev.azure.com/divvun/kbdgen/_apis/build/status/divvun.kbdgen?branchName=feature/py-in-rust)](https://dev.azure.com/divvun/kbdgen/_build/latest?definitionId=4&branchName=feature/py-in-rust) (`feature/py-in-rust`) |
